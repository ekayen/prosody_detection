...
proj_home=/home/${USER}/repos/stars
src_path=${proj_home}/data/burnc

# input data directory path on the scratch disk of the node
dest_path=${SCRATCH_HOME}/stars/data
...
rsync --archive --update --compress --progress ${proj_home}/speech_model/conf/ ${dest_path}
rsync --archive --update --compress --progress ${src_path}/burnc.pkl ${dest_path}
rsync --archive --update --compress --progress ${src_path}/splits/ ${dest_path}
